                        ...
                        <v-card class="grey lighten-2">
                           <v-card-title class="pa-5" style="color:#673AB7">Create new account </v-card-title>
                             ...
                             <v-form ref="form" @submit.prevent="createAccount" class="pa-5" style="margin-top:-10px" enctype="multi-part/form-data">
                                <v-text-field label="Name" :rules="rules" v-model="post.name" color="#673AB7" flat solo rounded prepend-inner-icon="mdi-account" ></v-text-field>
                                ...
                                <v-select prepend-inner-icon="mdi-eye" :rules="rules" v-model="post.location" solo flat rounded label="Location" :items="location"></v-select>
                                <v-file-input style="width:100%" label="select profile picture" solo rounded :rules="rules" @change="selectFile" show-size counter multiple ></v-file-input>
