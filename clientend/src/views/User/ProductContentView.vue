            ...
            <v-layout row wrap>
                <v-flex sm6 xs6 class="pa-1 ">
                    <v-card flat class="grey lighten-2 ma-2" :to="{name : 'product-details'}">
                        <v-img src="../../assets/images/product-140.jpg" style="height:18vh;" class="rounded-lg"></v-img>
                        <v-card-title>
                ...
                <v-flex sm6 xs6 class="pa-1 ">
                    <v-card flat class="grey lighten-2 ma-2" :to="{name : 'product-details'}">
                        <v-img src="../../assets/images/n55.jpg" style="height:18vh;" class="rounded-lg"></v-img>
                        <v-card-title>
                            <span style="font-size:10px;margin-top:-70px">Price : #10,000</span><br><br>
                        </v-card-title>
                        <v-toolbar  height='50' style="margin-top:-70px;" flat>
                ...
                <v-flex sm6 xs6 class="pa-1 ">
                    <v-card flat class="grey lighten-2 ma-2" :to="{name : 'product-details'}">
                        <v-img src="../../assets/images/n7.jpg" style="height:18vh;" class="rounded-lg"></v-img>
                        <v-card-title>
                ...
                <v-flex sm6 xs6 class="pa-1 ">
                    <v-card flat class="grey lighten-2 ma-2" :to="{name : 'product-details'}">
                        <v-img src="../../assets/images/n50.jpg" style="height:18vh;" class="rounded-lg"></v-img>
                        <v-card-title>
                            <span style="font-size:10px;margin-top:-70px">Price : #10,000</span><br><br>
                        </v-card-title>
                        <v-toolbar  height='50' style="margin-top:-70px;" flat>
                ...
                <v-flex sm6 xs6 class="pa-1 ">
                    <v-card flat class="grey lighten-2 ma-2" :to="{name : 'product-details'}">
                        <v-img src="../../assets/images/product-4.jpg" style="height:18vh;" class="rounded-lg"></v-img>
                        <v-card-title>
                ...
                <v-flex sm6 xs6 class="pa-1 ">
                    <v-card flat class="grey lighten-2 ma-2" :to="{name : 'product-details'}">
                        <v-img src="../../assets/images/product-10.jpg" style="height:18vh;" class="rounded-lg"></v-img>
                        <v-card-title>
                            <span style="font-size:10px;margin-top:-70px">Price : #100,000</span><br><br>
                        </v-card-title>
                        <v-toolbar  height='50' style="margin-top:-70px;" flat>
                ...
                <v-flex sm6 xs6 class="pa-1 ">
                    <v-card flat class="grey lighten-2 ma-2" :to="{name : 'product-details'}">
                        <v-img src="../../assets/images/n32.jpg" style="height:18vh;" class="rounded-lg"></v-img>
                        <v-card-title>
                            <span style="font-size:10px;margin-top:-70px">Price : #10,000</span><br><br>
                        </v-card-title>
                        <v-toolbar  height='50' style="margin-top:-70px;" flat>
                ...
                <v-flex sm6 xs6 class="pa-1 ">
                    <v-card flat class="grey lighten-2 ma-2" :to="{name : 'product-details'}">
                        <v-img src="../../assets/images/h.png" style="height:18vh;" class="rounded-lg"></v-img>
                        <v-card-title>
