<template>
    ...
    <v-container>
      ...
      <v-row>
        <v-col>
          ...
          <v-text-field v-model="newProduct.quantity" label="Product Price"></v-text-field>
  ...
  export default {
    ...
    methods: {
      ...
      async createProduct() {
        const response = await axios.post('https://fuoyemarket.intellicsolutions.org/api/seller/create-product', this.newProduct)
